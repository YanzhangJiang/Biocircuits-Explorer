...
if [ -z "${SRCROOT:-}" ] || [ -z "${TARGET_BUILD_DIR:-}" ] || [ -z "${CONTENTS_FOLDER_PATH:-}" ]; then
...
BACKEND_DESTINATION="${APP_HELPERS_DIR}/BiocircuitsExplorerBackend"
...
echo "Bundled Biocircuits Explorer backend into app Helpers: ${BACKEND_DESTINATION}"
