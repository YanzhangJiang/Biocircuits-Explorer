...
// ({provider, baseUrl, model, effort}). The shared llm-config module holds the API key in memory; it
...
import { DEFAULTS, EFFORTS, getLLMConfig, setLLMConfig, clearLLMConfig } from './llm-config.js';
export { getLLMConfig, setLLMConfig, clearLLMConfig } from './llm-config.js';
