...
RUN_ROOT="${RUN_ROOT:-$ATLAS_STORE_DIR/complex_growth_d3_local_v2}"
...
SPEC_OUT="$RUN_ROOT/report_d3_complex_growth_local.spec.json"
SUMMARY_OUT="$RAW_DIR/report_d3_complex_growth_local.summary.json"
SQLITE_RAW="$RAW_DIR/report_d3_complex_growth_local.sqlite"
SQLITE_V2="$OUT_DIR/report_d3_complex_growth_local_v2.sqlite"
STATS_V2="$OUT_DIR/report_d3_complex_growth_local_v2.stats.json"
...
raw["source_label"] = "report_d3_complex_growth_local"
raw.setdefault("source_metadata", {})
raw["source_metadata"].update(
    {
        "prepared_by": "run_d3_complex_growth_local_v2.sh",
...
echo "== Prepared Local d3 Complex-Growth Run =="
...
echo "== Running d3 complex-growth atlas scan =="
...
echo
echo "Completed local d3 complex-growth run."
