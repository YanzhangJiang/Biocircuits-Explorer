...
import Graphs, JSON3
using Base.Threads
include("/home/user/Biocircuits-Explorer-atlas-mu5/webapp/src/reaction_parser.jl")
using .ReactionParser: build_model

const OUTDIR    = get(ENV, "OUTDIR", "/home/user/bcx-resync-rebuild")
...
const DBS = [
    ("atlas_full", "/home/user/Biocircuits-Explorer-atlas-mu5/atlas_full/atlas.sqlite"),
    ("atlas_d4",   "/home/user/Biocircuits-Explorer-atlas-mu5/atlas_d4/atlas.sqlite"),
]
mkpath(OUTDIR)
